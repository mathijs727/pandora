...
sudo mkdir build
cd build
sudo cmake -GNinja -DPANDORA_BUILD_TESTS=ON -DPANDORA_BUILD_ATLAS=OFF -DCMAKE_CXX_FLAGS="-W -Wall -Wpedantic -Werror -Wno-unused-parameter -Wno-unused-variable -Wno-unused-private-field -mavx2 -mpopcnt -mbmi2" ../
sudo ninja -j1
