...
if __name__ == "__main__":
    ...
    if os.name == "nt":
        path = "E:/Pandora Scenes/PBRT/pbrt-v3-scenes/buddha-fractal/"
    else:
        path = "/mnt/e/Pandora Scenes/PBRT/pbrt-v3-scenes/buddha-fractal"
    file_path = os.path.join(path, "buddha-fractal.pbrt")
