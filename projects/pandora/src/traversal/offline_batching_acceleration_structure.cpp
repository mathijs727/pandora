...
std::vector<tasking::CachedPtr<Shape>> OfflineBatchingAccelerationStructureBuilder::makeSubSceneResident(const SubScene& subScene)
{
    OPTICK_EVENT();
...
SparseVoxelDAG OfflineBatchingAccelerationStructureBuilder::createSVDAG(const SubScene& subScene, int resolution)
{
    OPTICK_EVENT();
...
std::vector<Shape*> OfflineBatchingAccelerationStructureBuilder::getSubSceneShapes(const SubScene& subScene)
{
    OPTICK_EVENT();
