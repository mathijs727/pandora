...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Vec3i FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Vec3i() {
    memset(static_cast<void *>(this), 0, sizeof(Vec3i));
  }
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Vec3u FLATBUFFERS_FINAL_CLASS {
 private:
  uint32_t x_;
  uint32_t y_;
  uint32_t z_;
 ...
 public:
  Vec3u() {
    memset(static_cast<void *>(this), 0, sizeof(Vec3u));
  }
  Vec3u(uint32_t _x, uint32_t _y, uint32_t _z)
      : x_(flatbuffers::EndianScalar(_x)),
        y_(flatbuffers::EndianScalar(_y)),
        z_(flatbuffers::EndianScalar(_z)) {
  }
...
FLATBUFFERS_STRUCT_END(Vec3u, 12);
